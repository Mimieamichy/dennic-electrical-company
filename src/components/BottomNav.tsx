    ...
    <>
      ...
      <nav className="fixed inset-x-0 bottom-0 z-40 lg:hidden">
        <div className="mx-auto max-w-md px-3 pb-3">
          <div className="relative flex items-end justify-between rounded-2xl border border-white/10 bg-[color:var(--navy-deep)]/95 px-2 py-2 shadow-[0_-8px_24px_rgba(0,0,0,0.35)] backdrop-blur">
            ...
            <div className="-mt-8 flex flex-1 justify-center">
              <Link
                ...
                className="group flex h-16 w-16 flex-col items-center justify-center rounded-full bg-[color:var(--volt)] text-[color:var(--navy-deep)] shadow-[0_0_24px_var(--volt)] ring-4 ring-[color:var(--navy-deep)] transition active:scale-95"
              >
...
function NavItem({ item }: { item: (typeof ITEMS)[number] }) {
  ...
  return (
    <Link
      ...
      className="flex min-w-0 flex-1 flex-col items-center gap-1 px-1 py-2 text-white/60 transition hover:text-white"
