...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Voltaire" },
      { property: "og:title", content: "Dennic Electrical Construction Company · Home" },
      { property: "og:description", content: "Dennic Electrical Construction Company designs, constructs and commissions high-voltage electrical infrastructure — from 220 kV substations to industrial and renewable power systems." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Dennic Electrical Construction Company · Home" },
      { name: "twitter:description", content: "Dennic Electrical Construction Company designs, constructs and commissions high-voltage electrical infrastructure — from 220 kV substations to industrial and renewable power systems." },
