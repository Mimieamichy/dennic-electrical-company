...
import { Asterisk, Briefcase } from 'lucide-react'
      ...
      <section className="py-16 sm:py-24 md:py-32">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 md:px-10">
          ...
          <div className="mt-16 rounded-xl bg-navy/5 p-8 text-center sm:p-12">
            <h3 className="font-display text-xl font-bold text-navy">Ready to Apply?</h3>
            <p className="mt-3 text-sm text-navy">
              All persons applying should submit their resume and cover letter to <a href="mailto:dennicelectricals.co@gmail.com" className="font-medium text-[color:var(--crimson)] hover:underline">dennicelectricals.co@gmail.com</a>.
            </p>
          </div>
        </div>
      </section>
